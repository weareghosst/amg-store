 ...
 * (campo "Telefone/WhatsApp"); enquanto o banco não estiver configurado,
...
export async function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp shadow-lg shadow-black/20 transition hover:scale-105 hover:bg-whatsapp-dark"
    >
