...
const DEMO_CATEGORY_PRODUCTS: Record<string, Array<{ id: string; name: string; slug: string; description: string; sku: string; priceCents: number; comparePriceCents: number; stock: number; categoryId: string | null; imageUrl: string | null; active: boolean; createdAt: Date; updatedAt: Date; }>> = {
  "limpeza-higiene": [
    {
      id: "demo-kit-limpeza",
